...
void Class_Potential_R2HDM::SetCurvatureArrays()
{
  ...
  BuildHiggsTensorIndexCache();
  BuildGaugeTensorIndexCache();
  BuildQuarkTensorIndexCache();
  BuildLeptonTensorIndexCache();
  BuildVTreeTensorIndexCache();
