...
protected:
  ...
  size_t find_closest_hint(double x, size_t hint) const;
...
public:
  ...
  // Same polynomial evaluation with a reusable interval hint. The hint is
  // corrected in either direction and out-of-range values use the original
  // search, so the returned value is unchanged.
  double operator()(double x, size_t &hint) const;
  double deriv(int order, double x) const;
  double deriv(int order, double x, size_t &hint) const;
