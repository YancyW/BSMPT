...
public:
  ...
  /** Experimental lab-only legacy four-point-gradient shadow at one
   * temperature. Returns a positive action on success and -1 on failure. */
  double CalculateLegacyGradientShadowAt(double T,
                                         int max_path_integrations = 2);
